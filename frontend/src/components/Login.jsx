...
function Login({ onLogin }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      let response
      if (isLogin) {
        response = await apiLogin(formData.username, formData.password)
      } else {
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow">
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white hover:bg-gray-50 text-sm font-medium text-gray-700 transition-colors"
          >
            {/* Google logo SVG */}
